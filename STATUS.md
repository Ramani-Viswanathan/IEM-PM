...
- Not yet re-run: no audit has exercised fix #15 (the self-consistency check) or fix #17 (Principle 8)
  live yet — first real test is the next audit run.
